...
#QUESTÃO 4
select * from itens_notas_fiscais where QUANTIDADE >= 99 and PRECO > 44;
#RESPOSTA: O produto que representa o maior valor em vendas é o produto de id/código igual a '81959'.

#QUESTÃO 5
select * from itens_notas_fiscais where QUANTIDADE = 84 and CODIGO_DO_PRODUTO = '1101035' and NUMERO = 102;
